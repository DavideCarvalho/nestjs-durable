...
Each entity comes with a repository class, so app code that reads a durable table injects a typed
handle instead of passing the entity class to every call:
