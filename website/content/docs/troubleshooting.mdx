...
description: Symptom-first answers to the errors and stuck states you'll actually hit — NonDeterminismError, a run wedged in pending or suspended, SignalTimeoutError, dead-lettered runs, MySQL collation clashes, and an empty dashboard.
---
