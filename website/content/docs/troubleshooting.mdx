...
- Deploy the workers that run your workflow code **together** with the operator/API — a partial
  ...
  "stale local worker" pitfalls in [Tenancy](/docs/concepts/tenancy#pitfalls).
...
uses, and check `scopeReads`/`namespace` configuration. See [Tenancy](/docs/concepts/tenancy)
