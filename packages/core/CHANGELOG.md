...
- [#331](https://github.com/DavideCarvalho/nestjs-durable/pull/331) [`d2f6f07`](https://github.com/DavideCarvalho/nestjs-durable/commit/d2f6f07731dfce30770ee96c9fda78cfcba26ce9) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - A run is no longer executed twice when a fast step result races the orphan sweep.
...
- [#315](https://github.com/DavideCarvalho/nestjs-durable/pull/315) [`1499a1b`](https://github.com/DavideCarvalho/nestjs-durable/commit/1499a1b98478c51f8daa138ac8cc730e1a42d677) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - Tidy the gather re-drive landed in 0.70.2 — no behaviour change.
  ...
  served, which pins down that the engine recovers _out of_ the parked state. Without that,
...
- [#311](https://github.com/DavideCarvalho/nestjs-durable/pull/311) [`7c536bb`](https://github.com/DavideCarvalho/nestjs-durable/commit/7c536bbbd6b8caa258aff5063d023f01786e9a3a) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - Stop a remote `gather_calls` fan-out from orphaning its run for `reconcileMs`.
...
- 7885b5a: Stop a single unrecoverable run from crash-looping every worker.
...
- bcd31af: Fix: a singleton run handed a freed slot could be left suspended with no wake time and never resume
...
- 4c62762: A live worker is visible even when it announces nothing, and a version pin can fail
...
- 6402915: Let a deployment answer "what workflows exist here", from what workers announce.
