 ...
 * HMAC-SHA256, no store, `node:crypto` only — no JWT dependency. Mirrors
 * `@dudousxd/nestjs-telescope`'s `dashboardAuth` cookie mechanism so the behavior is familiar
 * across the aviary consoles.
 */
