...
- d64a1ee: Stop `BullMQTransport.close()` from hanging forever on a wedged worker
...
- 7dd8f45: Fix a permanent hang: `BullMQTransport`'s pub/sub subscriber connections (`onControl`,
